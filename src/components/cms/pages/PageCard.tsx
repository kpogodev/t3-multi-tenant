...
const PageCard = ({ id, name }: PageCardProps) => {
  ...
  return (
    <div className='relative z-0 flex flex-col items-center gap-3 rounded-md bg-base-200 p-4 shadow-md xl:gap-5'>
      <h3 className='text-center text-xl font-bold'>{capitalizeString(name)}</h3>
      <PageIcon className='aspect-square w-1/2 max-w-[150px] opacity-40' />
